...
<b>3)</b> 	dopo aver usato scandir.php, usare "<i>php aggrionadb.php</i>" solo se avete dei file .nfo con 
	...
	<br>
<li>
	<b>4)</b> 	con <i>php aggiornadaimdb.php</i> è possibile "recuperare" dalle pagine in inglese del sito IMDb tutti i dati che servono per completare la palylist (generi, registi, anno e durata). Recupera anche altri dati che al momento non sono gestiti dal database previsto per questi script. Nulla vieta di usare in combinazione il punto 3) ed il punto 4). <i>aggiornadaimdb.php</i> crea anche un log (nella cartella "log") per monitorare la ricerca dei titoli e l'aggiornamento della base dati.<br>
	<b>N.B.:</b> Usate questo script con discrezione, lo scabing non è sempre visto bene.
</li>
	<br>
	<li>
